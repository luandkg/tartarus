...
public class FutebolDados {
    ...
    public void ler() {
        ...
        for (String linha : linhas) {
            ...
            if (Texto.igual(valores.get(0), "JOGADOR")) {
                Jogador j = new Jogador(valores.get(1), Integer.parseInt(valores.get(3)), valores.get(4), Tempo.parseData(valores.get(5)), Tempo.parseData(valores.get(6)), Tempo.parseHorario(valores.get(7)), Tempo.parseHorario(valores.get(8)));
    ...
    public void salvar() {
        ...
        for (Jogador jogador : jogadores) {
            doc += "JOGADOR\t" + jogador.getNome() + "\t" + jogador.getTimeID() + "\t" + jogador.getUniforme() + "\t" + jogador.getPosicao() + "\t" + jogador.getDataCriada().toString() + "\t" + jogador.getDataModificada().toString() + "\t" + jogador.getHorarioCriado().toString() + "\t" + jogador.getHorarioModificado().toString() + "\n";
        }
