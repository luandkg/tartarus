...
public class JogadorSerializavel implements Serializavel<Jogador> {
    ...
    public Jogador destransforma(String valor) {
        ...
        Jogador j = new Jogador(lista.get(0),Integer.parseInt(lista.get(2)),lista.get(3), Tempo.parseData(lista.get(4)), Tempo.parseData(lista.get(5)), Tempo.parseHorario(lista.get(6)), Tempo.parseHorario(lista.get(7)));
