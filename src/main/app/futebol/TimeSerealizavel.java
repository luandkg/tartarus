...
public class TimeSerealizavel implements Serializavel<Time> {
    ...
    public Time destransforma(String valor) {
        ...
        Time j = new Time(Integer.parseInt(lista.get(0)), lista.get(1), Tempo.parseData(lista.get(2)), Tempo.parseData(lista.get(3)), Tempo.parseHorario(lista.get(4)), Tempo.parseHorario(lista.get(5)));
        return j;
    }
